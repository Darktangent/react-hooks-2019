...
const handleClearSearch=()=>{
  ...
  return (
    ...
    <input type="text" onChange={event=>setQuery(event.target.value)} value={query} ref={searchInputRef} border p-1 rounded/>
    ...
    {loading? (<div className="font-bold text-orange-dark">Loading page</div>):
